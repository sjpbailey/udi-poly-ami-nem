...
editor_tree = ET.parse('/Users/stevenbailey/UDI Development/Nodeservers/udi-poly-ami-nem/profile/editor/editors.xml')
...
nls = {}
with open('/Users/stevenbailey/UDI Development/Nodeservers/udi-poly-ami-nem/profile/nls/en_us.txt') as fp:
    for line in fp:
        line = line.rstrip()
        if line != "" and line[0] != '#':
            pair = line.split(" = ")
...
node_tree = ET.parse('/Users/stevenbailey/UDI Development/Nodeservers/udi-poly-ami-nem/profile/nodedef/nodedefs.xml')
